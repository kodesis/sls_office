        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel card">
                <div class="x_content">
                    ...
                    <form action="<?= base_url('financial/approve_fe_multiple') ?>" method="post" id="form-input">
                        <?php
                        if ($key == 'pending') :
                            if ($fes) { ?>
                                <div class="row">
                            ...
                            <table id="" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        ?>
                                            <th>
                                                <input <?= (!$fes) ? 'disabled' : '' ?> type="checkbox" id="checkAllCheckbox" class="form-check-input">
                                            </th>
                                        <?php
                                        endif; ?>
                                        <th>No.</th>
                                    ...
                                    if ($fes) {
                                        foreach ($fes as $i) :
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                    <td>
                                                        <input class="form-check-input" type="checkbox" id="gridCheck<?= $i['slug'] ?>" name="pilih[]" value="<?= $i['slug'] ?>">
                                                    </td>
                                                <?php
                                                endif; ?>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="badge bg-blue" data-toggle="modal" data-target="#modal<?= $i['Id'] ?>">Lihat</button>
                                                </td>
                                            </tr>
...
<script>
    $(document).ready(function() {
        ...
        $('#checkAllCheckbox').on('change', function() {
            // Mengatur status centang semua kotak centang berdasarkan status checkbox
            $('input[name="pilih[]"]').prop('checked', $(this).prop('checked'));
        });
    })
    ...
    document.getElementById('form-input').addEventListener('submit', function(e) {
        ...
        if (checkboxes.length === 0) {
            ...
            alert('Pilih minimal satu data sebelum menyetujui.');
        }
    });
</script>