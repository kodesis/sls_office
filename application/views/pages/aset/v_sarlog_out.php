        ...
        <div class="x_content">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 form-group" style="margin: 0; padding:0;">
              <?php if ($this->uri->segment(2) == 'sarlog_out_approve') { ?>
                <form class="form-horizontal form-label-left" method="get" action="<?= base_url('asset/sarlog_out_approve') ?>">
                  <div class="input-group">
                    ...
                    <span class="input-group-btn">
                      ...
                      <a href="<?= base_url('asset/sarlog_out_approve') ?>" class="btn btn-warning" style="color:white;">Reset</a>
                    </span>
                  </div><!-- /input-group -->
                </form>
              <?php } else {  ?>
                <form class="form-horizontal form-label-left" method="get" action="<?= base_url('asset/sarlog_out') ?>">
                  <div class="input-group">
                    ...
                    <span class="input-group-btn">
                      <button class="btn btn-default" type="submit">Search</button>
                      <a href="<?= base_url('asset/sarlog_out') ?>" class="btn btn-warning" style="color:white;">Reset</a>
                    </span>
                  </div><!-- /input-group -->
                </form>
              <?php } ?>
